 ...
 */
public class IdCard {
	private volatile static IdCard singleton;

	private IdCard() {
	}

	public static IdCard getSingleton() {
		if (singleton == null) {
			synchronized (IdCard.class) {
				if (singleton == null) {
					singleton = new IdCard();
				}
			}
		}
		return singleton;
	...
	public String getProvince() {
		return this.isCorrect() ? this.idCardNum.substring(0, 2) : "";
	}
	...
	public String getCity() {
		return this.isCorrect() ? this.idCardNum.substring(2, 4) : "";
	}
	...
	public String getCountry() {
		return this.isCorrect() ? this.idCardNum.substring(4, 6) : "";
	}
	...
	public String getBirthday() {
		...
		if (this.getLength() == 15) {
			date = "19" + this.idCardNum.substring(6, 12);
		} else {
			date = this.idCardNum.substring(6, 14);
		}
	...
	public String getCheck() {
		...
		if (this.getLength() == 18)
			return this.idCardNum.substring(17).equals("x") ? "X"
					: this.idCardNum.substring(17);
		else
	...
	public boolean isCorrect() {
		...
		if (this.is18()) {
			System.out.println("this.getCheck():" + this.getCheck());
