 ...
 * 类说明
 **/
public class DoctorRowDataObj {

	private String doctor_Id; // 14956008,
	private String patient_Department; // 内一病区,
	private String doctor_Content; // 白蛋白/球蛋白,
	private String sample_Site; // 静脉血,
	private String collection_Way; // 静脉采血,
	private String doctor_No; // Q2140152,
	private String patient_Source; // 住院,
	private String patient_Id; // 395157,
	private String homepage_Id; // 1,
	private String patient_Name; // 雷霆,
	private String patient_Gender; // 男,
	private String patient_Age; // 29岁,
	private String Outpatient_Number; // 9634783,
	private String Inpatient_Number; // 3914548,
	private String bed_No; // 73,
	private String bar_Code; // null,
	private String apply_Name; // 系统管理员,
	private String apply_Time; // 2016/11/5 9; //23; //00,
	private String sampling_Name; // 系统管理员,
	private String sampling_Time; // 2016/11/5 9; //23; //27,
	private String Inspection_Name; // null,
	private String Inspection_Time; // null,
	...
	public String getCollection_Way() {
		return collection_Way;
	}
	public void setCollection_Way(String collection_Way) {
		this.collection_Way = collection_Way;
	}
	...
	public void setSampling_Name(String sampling_Name) {
		this.sampling_Name = sampling_Name;
	}
